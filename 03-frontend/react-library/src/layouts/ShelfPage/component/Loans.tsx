...
import ShelfCurrent from "../../../models/ShelfCurrentLoans";
...
export const Loans = () => {
    ...
    // Current Loans
    const [shelfCurrentLoans, setShelfCurrentLoans] = useState<ShelfCurrent[]>([]);
                    ...
                    <>
                        ...
                        {shelfCurrentLoans.map(shelfCurrentLoans => (
                            <div key={shelfCurrentLoans.book.id}>
                                            ...
                                            <div className="mt-3">
...

                                                {
                                                    ...
                                                    <p className="text-danger">
                                                        Past due day {shelfCurrentLoans.daysLeft} days.
                                                    </p>
                                                }
                                ...
                                <hr />
                                <LoansModel mobile={false} shelfCurrentLoan={shelfCurrentLoans} returnBook={returnBook} renewLoan={renewLoan} />
                            </div>
                        ))}
                    </> :
                ...
                <>
                    ...
                    {shelfCurrentLoans.map(shelfCurrentLoans => (
                        <div key={shelfCurrentLoans.book.id}>
                            ...
                            <hr />
                            <LoansModel mobile={true} shelfCurrentLoan={shelfCurrentLoans} returnBook={returnBook} renewLoan={renewLoan} />
                        </div>
                    ))}
                </> :
